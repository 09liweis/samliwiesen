...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Visual_vue__ = __webpack_require__(24);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
	...
	methods: {
		...
		filter: function filter() {
			...
			this.$http.get('https://what-i-watched.herokuapp.com/api/visuals?type=not_start').then(function (res) {
				if (res.ok) {
					_this4.list = res.body.results;
				}
			});
		}
	}
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    getLink: function getLink(id, type) {
      if (type == 'douban') {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    editField: function editField(k) {
      this.currentField = k;
      this.currentVal = this.visual[k];
    },
    updateField: function updateField(k) {
    ...
    renderDouban: function renderDouban() {
      ...
      var douban_id = this.visual.douban_id;
      ...
      this.$http.get(api).then(function (res) {
        ...
        _this3.visual = Object.assign(_this3.visual, douban);
        if (douban.episodes > 1) {
          _this3.visual.visual_type = 'tv';
        }
        _this3.release_dates = douban.release_dates;
        _this3.renderIMDB();
      }, function (res) {
        //error
      });
      ...
      this.$http.jsonp('https://www.omdbapi.com/', options).then(function (res) {
        if (res.body.Response != 'False') {
          if (res.body.Ratings[1] && res.body.Ratings[1].Source == 'Rotten Tomatoes') {
            _this4.visual.rotten_rating = res.body.Ratings[1].Value.replace('%', '');
          }
          _this4.posters.push(res.body.Poster);
        }
      });
      var api = '/api/visuals/get_imdb_rating?imdb_id=' + this.visual.imdb_id;
      // 'https://what-i-watched.herokuapp.com/api/get_imdb_detail?imdb_id='+this.visual.imdb_id
      this.$http.get(api).then(function (res) {
        if (res.status == 200) {
          if (res.body.imdb_rating) {
            _this4.visual.imdb_rating = res.body.imdb_rating;
          }
        }
      });
    },
...
var _museUi = __webpack_require__(17);
...
var _Visuals = __webpack_require__(20);

var _Visuals2 = _interopRequireDefault(_Visuals);

var _VisualForm = __webpack_require__(29);

var _VisualForm2 = _interopRequireDefault(_VisualForm);

var _SongForm = __webpack_require__(33);

var _SongForm2 = _interopRequireDefault(_SongForm);

var _ImageForm = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_27e14ad4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Visuals_vue__ = __webpack_require__(28);
var disposed = false
...
var update = __webpack_require__(5)("89c68236", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_dcae774a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Visual_vue__ = __webpack_require__(27);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("2819b157", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c("tr", { staticClass: "visual" }, [
    ...
    _vm._v(" "),
    _c("th", [
      _c("div", [_vm._v(_vm._s(_vm.v.countries.join(",")))]),
      _vm._v(" "),
      _c("div", [_vm._v(_vm._s(_vm.v.languages.join(",")))])
    ]),
    _vm._v(" "),
      ...
      _c("div", { staticClass: "visual__ratings" }, [
        _c(
          "a",
          {
            ...
            attrs: {
              href: _vm.getLink(_vm.v.douban_id, "douban"),
              target: "_blank"
            }
          },
          [
        ...
        _vm.v.imdb_id
          ? _c(
              "a",
              {
                staticClass: "visual__rating link",
                attrs: {
                  href: _vm.getLink(_vm.v.imdb_id, "imdb"),
                  target: "_blank"
                }
              },
              [
                _c("span", { staticClass: "visual__rating icon imdb" }, [
                  _vm._v("IMDB")
                ]),
                _vm._v(" "),
                _c("span", { staticClass: "visual__rating" }, [
      ...
      _c(
        ...
        [
          _c("mu-linear-progress", {
            attrs: {
              mode: "determinate",
              value: (_vm.v.current_episode / _vm.v.episodes) * 100
            }
          })
        ],
        1
    ...
    _c("th", { staticClass: "visual__col release_date" }, [
      ...
      _vm._v(" "),
      _vm.v.duration
        ? _c("div", [_vm._v(_vm._s(_vm.v.duration) + " mins")])
        : _vm._e()
    ]),
    _vm._v(" "),
                ...
                "a",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.increaseEpisode(_vm.v)
                    }
                  }
                },
                [_vm._v("+ 1 ep")]
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0707a793_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_VisualForm_vue__ = __webpack_require__(32);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("519f1185", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
  ...
  return _c("div", { staticClass: "form" }, [
    _c("div", { staticStyle: { display: "flex" } }, [
      _c(
        ...
        _vm._l(_vm.visual, function(v, k) {
          return _c("div", { key: k }, [
            _c("div", [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "input-form", staticStyle: { width: "50%" } }, [
        _c("div", { staticClass: "input-form-group" }, [
          _c("label", [_vm._v(_vm._s(_vm.currentField))]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
          ...
          _c(
            "a",
            {
              on: {
                click: function($event) {
                  return _vm.updateField(_vm.currentField)
                }
              }
            },
            [_vm._v("Update")]
        ...
        _vm._v(" "),
        _vm.currentField == "release_date"
          ? _c(
              "div",
              _vm._l(_vm.release_dates, function(d) {
                return _c(
                  "div",
                  {
                    key: d,
                    on: {
                      click: function($event) {
                        _vm.currentVal = d.substring(0, 10)
                      }
                    }
                  },
                  [_vm._v(_vm._s(d))]
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.currentField == "poster" && _vm.posters.length > 0
          ? _c(
              "div",
        ...
        _vm._v(" "),
        _c("button", { on: { click: _vm.handleSubmit } }, [_vm._v("Submit")])
      ])
    ])
  ])
}
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_04f73a28_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SongForm_vue__ = __webpack_require__(34);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_68374a20_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ImageForm_vue__ = __webpack_require__(36);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_472cff63_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(42);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(5)("018951da", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
