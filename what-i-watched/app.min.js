...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Visual_vue__ = __webpack_require__(25);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    components: {
        Visual: __WEBPACK_IMPORTED_MODULE_0__components_Visual_vue__["a" /* default */]
    },
    data: function data() {
        return {
            searchText: '',
    ...
    computed: {
        resultVisuals: function resultVisuals() {
            var _this = this;

            if (this.filters.length != 0) {
                return this.list.filter(function (v) {
                    if (_this.filters.indexOf('not_start') != -1) {
                        return v.current_episode == 0;
                    } else {
                        return _this.filters.indexOf(v.visual_type) != -1;
                    }
                });
            } else {
                return this.list;
    ...
    methods: {
        ...
        getVisuals: function getVisuals() {
            var _this2 = this;
            ...
            this.$http.get(this.$store.state.api.visualList, { params: params }).then(function (res) {
                _this2.list = res.body.results;
                _this2.total = res.body.total;
                _this2.totalPages = Math.ceil(_this2.total / _this2.limit);
        ...
        search: function search() {
            ...
            this.$http.get('https://what-i-watched.herokuapp.com/api/search?keyword=' + this.searchText).then(function (res) {
                if (res.ok) {
                    _this3.list = res.body.results;
                }
            });
        }
    }
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        increaseEpisode: function increaseEpisode(v) {
            var _this = this;

            this.$http.get(this.$store.state.api.increaseEpisode + '?id=' + v.id).then(function (res) {
                v.current_episode = res.body.current_episode;
                _this.getVisuals();
            });
        },
        getStatus: function getStatus(v) {
        ...
        getLink: function getLink(v, type) {
            if (type == 'douban') {
        ...
        getProgress: function getProgress(v) {
            if (v.current_episode == v.episodes) {
                return 100;
            }
            return v.current_episode / v.episodes * 100;
        },
        getWebsite: function getWebsite(website) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        gotoAddSong: function gotoAddSong() {
            this.$router.push({ path: '/' + this.$route.params.id + '/song/add' });
        },
        gotoAddImage: function gotoAddImage() {
            this.$router.push({ path: '/' + this.$route.params.id + '/image/add' });
        },
        renderFromSearch: function renderFromSearch(id) {
            this.toggleSearch();
        ...
        handleSubmit: function handleSubmit() {
            ...
            var options = this.visual;
            this.$http.post(this.$store.state.api.visualSubmit, options).then(function (res) {
                if (res.status == 200) {
        ...
        getVisual: function getVisual(id) {
            var _this2 = this;

            this.$http.get(this.$store.state.api.visualDetail + id).then(function (res) {
                _this2.visual = res.body.result;
            });
        },
        searchDouban: function searchDouban(e) {
            var _this3 = this;

            var val = e.target.value;
            this.$http.jsonp('https://api.douban.com/v2/movie/search?q=' + val).then(function (res) {
                _this3.searchs = [];
                if (res.status == 200) {
                    _this3.searchs = res.body.subjects;
                }
            });
        },
        renderDouban: function renderDouban() {
            var _this4 = this;
            ...
            this.getImdbId();
            this.$http.jsonp('https://api.douban.com/v2/movie/subject/' + this.visual.douban_id + '?apikey=0df993c66c0c636e29ecbb5344252a4a').then(function (res) {
                var douban = res.body;
                if (_this4.visual.summary == '') {
                    _this4.visual.summary = douban.summary;
                }
                _this4.release_dates = douban.pubdates;
                _this4.posters = [];

                _this4.visual.title = douban.title;
                _this4.visual.original_title = douban.original_title;
                _this4.visual.douban_rating = douban.rating.average;
                if (douban.episodes_count) {
                    _this4.visual.episodes = douban.episodes_count;
                    _this4.visual.visual_type = 'tv';
                }
                _this4.visual.website = douban.website;
            }, function (res) {
                //error
            });
        },
        getImdbId: function getImdbId() {
            var _this5 = this;
            ...
            this.$http.get(this.$store.state.api.visualImdb, options).then(function (res) {
                _this5.visual.imdb_id = res.body.imdb_id;
                // this.release_dates = res.body.release_dates;
                _this5.renderIMDB();
            }, function (res) {});
        },
        renderIMDB: function renderIMDB() {
            var _this6 = this;
            ...
            this.$http.jsonp('https://www.omdbapi.com/', options).then(function (res) {
                if (res.body.Response != 'False') {
                    if (res.body.Ratings[1] && res.body.Ratings[1].Source == 'Rotten Tomatoes') {
                        _this6.visual.rotten_rating = res.body.Ratings[1].Value.replace('%', '');
                    }
                    _this6.posters.push(res.body.Poster);
                }
            });
            this.$http.get('https://what-i-watched.herokuapp.com/api/get_imdb_detail?imdb_id=' + this.visual.imdb_id).then(function (res) {
                if (res.status == 200) {
                    _this6.visual.imdb_rating = res.body.imdb_rating;
                }
            });
        },
        getSongs: function getSongs(visual_id) {
            var _this7 = this;

            this.$http.get(this.$store.state.api.songList + '?visual_id=' + visual_id).then(function (res) {
                if (res.status == 200) {
                    _this7.songs = res.body.results;
                }
            });
        },
        editSong: function editSong(s) {
            var visual_id = this.$route.params.id;
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    mounted: function mounted() {
        var id = this.$route.params.songId;
        if (typeof id != 'undefined') {
            this.getSong(id);
        }
    },
    ...
    methods: {
        getSong: function getSong(id) {
            ...
            this.$http.get(this.$store.state.api.songDetail + id).then(function (res) {
                if (res.status == 200) {
                    _this.song = res.body.result;
                }
            });
        },
        selectSong: function selectSong(s) {
        ...
        handleSearch: function handleSearch() {
            ...
            var url = 'https://c.y.qq.com/soso/fcgi-bin/search_for_qq_cp?g_tk=5381&uin=0&format=jsonp&inCharset=utf-8&outCharset=utf-8&notice=0&platform=h5&needNewCode=1&w=' + this.search + '&zhidaqu=1&catZhida=1&t=0&flag=1&ie=utf-8&sem=1&aggr=0&perpage=20&n=20&p=1&remoteplace=txt.mqq.all&_=1520833663464';
            this.dataSource = [];
        ...
        handleSubmit: function handleSubmit() {
            ...
            var options = this.song;
            this.$http.post(this.$store.state.api.songSubmit, options).then(function (res) {
                if (res.status == 200) {
                    _this3.$router.push({ path: '/visuals/edit/' + _this3.song.visual_id });
                }
            });
        }
    }
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        handleSubmit: function handleSubmit() {
            ...
            var options = this.image;
            this.$http.post(this.$store.state.api.imageSubmit, options).then(function (res) {
                if (res.status == 200) {
                    _this.$router.push({ path: '/visuals/edit/' + _this.image.visual_id });
                }
            });
        }
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__views_MusicPlayer_vue__ = __webpack_require__(43);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    components: {
        MusicPlayer: __WEBPACK_IMPORTED_MODULE_0__views_MusicPlayer_vue__["a" /* default */]
    },
    data: function data() {
        return {};
    },
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        getSongs: function getSongs() {
            ...
            this.$http.get(this.$store.state.api.songList).then(function (res) {
                _this.songs = res.body.results;
...
var _museUi = __webpack_require__(18);
...
var _Visuals = __webpack_require__(21);

var _Visuals2 = _interopRequireDefault(_Visuals);

var _VisualForm = __webpack_require__(30);

var _VisualForm2 = _interopRequireDefault(_VisualForm);

var _SongForm = __webpack_require__(34);

var _SongForm2 = _interopRequireDefault(_SongForm);

var _ImageForm = __webpack_require__(36);
...
exports.default = new _vueRouter2.default({
     //mode: 'history',
     base: __dirname,
     routes: [{ path: '/', component: _Visuals2.default, name: 'home' }, { path: '/page/:pageId', component: _Visuals2.default, name: 'page' }, { path: '/add', component: _VisualForm2.default }, { path: '/edit/:id', component: _VisualForm2.default, name: 'edit' }, { path: '/:id/song/add', component: _SongForm2.default, name: 'addSong' }, { path: '/song/:songId/edit', component: _SongForm2.default, name: 'editSong' }, { path: '/:id/image/add', component: _ImageForm2.default, name: 'addImage' }]
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Visuals_vue__ = __webpack_require__(6);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_27e14ad4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Visuals_vue__ = __webpack_require__(29);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Visuals_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_27e14ad4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Visuals_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "views/Visuals.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-27e14ad4", Component.options)
  } else {
    hotAPI.reload("data-v-27e14ad4", Component.options)
  }
...
var update = __webpack_require__(2)("89c68236", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-27e14ad4\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Visuals.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-27e14ad4\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Visuals.vue");
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Visual_vue__ = __webpack_require__(7);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_dcae774a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Visual_vue__ = __webpack_require__(28);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_dcae774a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Visual_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "components/Visual.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-dcae774a", Component.options)
  } else {
    hotAPI.reload("data-v-dcae774a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("2819b157", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dcae774a\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Visual.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dcae774a\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Visual.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c("tr", { staticClass: "visual" }, [
    _c("th", [
      _c("img", {
        staticClass: "visual__poster",
        attrs: { src: _vm.v.poster, referrerpolicy: "never" }
      })
    ]),
    _vm._v(" "),
    _c("th", { staticClass: "visual__col title" }, [
      _c("h3", { staticClass: "visual__title" }, [
        _vm._v(_vm._s(_vm.v.title) + " "),
        _vm.v.website
          ? _c(
              "a",
              {
                attrs: { href: _vm.getWebsite(_vm.v.website), target: "_blank" }
              },
              [_vm._v("Website")]
            )
          : _vm._e()
      ...
      _vm._v(" "),
      _vm.v.title != _vm.v.original_title
        ? _c("h3", { staticClass: "visual__title" }, [
            _vm._v(_vm._s(_vm.v.original_title))
          ])
        : _vm._e()
    ]),
    _vm._v(" "),
    _c("th", [
      _vm._v("\n        " + _vm._s(_vm.v.countries.join(",")) + "\n    ")
    ]),
    _vm._v(" "),
    _c("th", [_vm._v(_vm._s(_vm.v.languages.join(",")))]),
    _vm._v(" "),
    _c("th", { staticClass: "visual__col ratings" }, [
      _c("div", { staticClass: "visual__ratings" }, [
        _c(
          "a",
          {
            staticClass: "visual__rating link",
            attrs: { href: _vm.getLink(_vm.v, "douban"), target: "_blank" }
          },
          [
            _c("img", {
              staticClass: "visual__rating icon",
              attrs: {
                src:
                  "https://img3.doubanio.com/f/talion/2f3c0bc0f35b031d4535fd993ae3936f4e40e6c8/pics/icon/dou32.png",
                alt: "douban icon"
              }
            }),
            _vm._v(" "),
            _c("span", { staticClass: "visual__rating" }, [
              _vm._v(_vm._s(_vm.v.douban_rating))
            ])
          ]
        ),
        _vm._v(" "),
        _vm.v.imdb_id
          ? _c(
              ...
              {
                staticClass: "visual__rating link",
                attrs: { href: _vm.getLink(_vm.v, "imdb"), target: "_blank" }
              },
              [
                _c("img", {
                  staticClass: "visual__rating icon",
                  attrs: {
                    src:
                      "https://a4.mzstatic.com/us/r30/Purple71/v4/eb/6a/9d/eb6a9d94-4631-194c-3e24-852a06dc4ced/icon175x175.jpeg",
                    alt: "imdb icon"
                  }
                }),
                _vm._v(" "),
                _c("span", { staticClass: "visual__rating" }, [
                  _vm._v(_vm._s(_vm.v.imdb_rating))
                ])
              ]
            )
          : _vm._e(),
        ...
        _vm.v.rotten_rating
          ? _c("a", [
              _c("img", {
                ...
                attrs: {
                  src:
                    "https://vignette.wikia.nocookie.net/greatest-movies/images/1/16/Rotten_Tomatoes_fresh_rating_icon.png/revision/latest?cb=20170918174417",
                  alt: "Rotten Tomatoes Icon"
                }
              }),
              _vm._v(" "),
              _c("span", { staticClass: "visual__rating" }, [
                _vm._v(_vm._s(_vm.v.rotten_rating))
              ])
            ])
          : _vm._e()
      ])
    ...
    _vm._v(" "),
    _c("th", { staticClass: "visual__col progress" }, [
      _c("span", { staticClass: "visual__progress-episodes" }, [
        _vm._v(_vm._s(_vm.v.current_episode) + " / " + _vm._s(_vm.v.episodes))
      ]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "visual__progress" },
        [
          _c("mu-linear-progress", {
            attrs: { mode: "determinate", value: _vm.getProgress(_vm.v) }
          })
        ],
        1
      )
    ...
    _vm._v(" "),
    _c("th", { staticClass: "visual__col release_date" }, [
      _c("span", [_vm._v(_vm._s(_vm.v.release_date))])
    ]),
    _vm._v(" "),
    _c("th", { staticClass: "visual__col actions" }, [
      _c(
        "div",
        { staticClass: "visual__action" },
        [
          _c(
            "router-link",
            { attrs: { to: { name: "edit", params: { id: _vm.v.id } } } },
            [_vm._v("Edit")]
          ),
          _vm._v(" "),
          _vm.v.episodes != _vm.v.current_episode
            ? _c(
                "a",
                {
                  staticClass: "visual__increaseepisode",
                  on: {
                    click: function($event) {
                      _vm.increaseEpisode(_vm.v)
                    }
                  }
                },
                [_vm._v("+ 1 ep")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-dcae774a", esExports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("h2", [_vm._v("I have watched " + _vm._s(_vm.total))]),
      _vm._v(" "),
      _vm.list.length == 0
        ? _c("mu-circular-progress", { attrs: { size: 90, color: "red" } })
        : _vm._e(),
      _vm._v(" "),
      ...
      _vm._v(" "),
      _vm.resultVisuals.length > 0
        ? _c("table", { staticClass: "table" }, [
            _vm._m(0),
            _vm._v(" "),
            _c(
              "tbody",
              _vm._l(_vm.resultVisuals, function(v) {
                return _c("Visual", {
                  key: v.id,
                  attrs: { v: v, getVisuals: _vm.getVisuals }
                })
              }),
              1
            )
      ...
      _vm._v(" "),
      _vm.list.length > 0
        ? _c("transition-group", { attrs: { name: "visual", appear: "" } })
        : _vm._e(),
      _vm._v(" "),
      _vm.total != 0
        ? _c(
            ...
            _vm._l(_vm.totalPages, function(p) {
              return _c(
                "router-link",
                {
                  ...
                  class: { active: _vm.page == p },
                  attrs: { to: { name: "page", params: { pageId: p } } }
                },
                [_vm._v(_vm._s(p))]
              )
            }),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("tr", { staticClass: "table__head" }, [
      _c("th", [_vm._v("Poster")]),
      _vm._v(" "),
      _c("th", [_vm._v("Title")]),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-27e14ad4", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_VisualForm_vue__ = __webpack_require__(8);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0707a793_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_VisualForm_vue__ = __webpack_require__(33);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_VisualForm_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0707a793_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_VisualForm_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "views/VisualForm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0707a793", Component.options)
  } else {
    hotAPI.reload("data-v-0707a793", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("519f1185", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0707a793\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./VisualForm.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0707a793\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./VisualForm.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
    ...
    [
      ...
      _c(
        ...
        [
          _c("mu-text-field", {
            attrs: {
              fullWidth: "",
              label: "Search From Douban",
              labelFloat: ""
            },
            on: { change: _vm.searchDouban }
          }),
          _vm._v(" "),
          _c(
            "mu-list",
            _vm._l(_vm.searchs, function(s) {
              return _c(
                "mu-list-item",
                {
                  key: "s.id",
                  ...
                  on: {
                    click: function($event) {
                      _vm.renderFromSearch(s.id)
                    }
                  }
                },
                [
                  _c("mu-avatar", {
                    attrs: { slot: "rightAvatar", src: s.images.large },
                    slot: "rightAvatar"
                  })
                ],
                1
      ...
      _c(
        ...
        [
          _c(
            "mu-col",
            { attrs: { width: "100", tablet: "50", desktop: "25" } },
            [
              _c("mu-text-field", {
                attrs: { fullWidth: "", label: "Title", labelFloat: "" },
                model: {
                  value: _vm.visual.title,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "title", $$v)
                  },
                  expression: "visual.title"
                }
              })
            ],
            1
          ...
          _c(
            ...
            [
              _c("mu-text-field", {
                ...
                model: {
                  value: _vm.visual.original_title,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "original_title", $$v)
                  },
                  expression: "visual.original_title"
                }
              })
            ],
            1
          ...
          _c(
            ...
            [
              _c("mu-text-field", {
                attrs: { fullWidth: "", label: "Douban Id", labelFloat: "" },
                on: { change: _vm.renderDouban },
                model: {
                  value: _vm.visual.douban_id,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "douban_id", $$v)
                  },
                  expression: "visual.douban_id"
                }
              })
            ],
            1
          ...
          _c(
            ...
            [
              _c("mu-text-field", {
                ...
                model: {
                  value: _vm.visual.douban_rating,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "douban_rating", $$v)
                  },
                  expression: "visual.douban_rating"
                }
              })
            ],
            1
      ...
      _c("mu-raised-button", {
        staticClass: "demo-raised-button",
        attrs: { label: "Get Douban Data", secondary: "" },
        on: { click: _vm.renderDouban }
      }),
      _vm._v(" "),
      _c(
        "mu-row",
        ...
        [
          _c(
            ...
            [
              _c("mu-text-field", {
                attrs: { fullWidth: "", label: "IMDB ID", labelFloat: "" },
                on: { change: _vm.renderIMDB },
                model: {
                  value: _vm.visual.imdb_id,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "imdb_id", $$v)
                  },
                  expression: "visual.imdb_id"
                }
              })
            ],
            1
          ...
          _c(
            ...
            [
              _c("mu-text-field", {
                attrs: { fullWidth: "", label: "IMDB Rating", labelFloat: "" },
                model: {
                  value: _vm.visual.imdb_rating,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "imdb_rating", $$v)
                  },
                  expression: "visual.imdb_rating"
                }
              })
            ],
            1
          ...
          _c(
            ...
            [
              _c("mu-text-field", {
                attrs: { fullWidth: "", label: "Episodes", labelFloat: "" },
                model: {
                  value: _vm.visual.episodes,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "episodes", $$v)
                  },
                  expression: "visual.episodes"
                }
              })
            ],
            1
          ...
          _c(
            ...
            [
              _c("mu-text-field", {
                ...
                model: {
                  value: _vm.visual.current_episode,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "current_episode", $$v)
                  },
                  expression: "visual.current_episode"
                }
              })
            ],
            1
      ...
      _c("mu-raised-button", {
        staticClass: "demo-raised-button",
        attrs: { label: "Get IMDB Data", secondary: "" },
        on: { click: _vm.renderIMDB }
      }),
      _vm._v(" "),
      _c(
        "mu-row",
        [
            ...
            [
              _c(
                "mu-select-field",
                {
                  ...
                  model: {
                    value: _vm.visual.release_date,
                    callback: function($$v) {
                      _vm.$set(_vm.visual, "release_date", $$v)
                    },
                    expression: "visual.release_date"
                  }
                },
                _vm._l(_vm.release_dates, function(release_date) {
                  return _c("mu-menu-item", {
                    key: release_date,
                    attrs: {
                      label: release_date,
                      value: release_date.substring(0, 10),
                      title: release_date
                    }
                  })
                }),
          ...
          _c(
            ...
            [
              _c("mu-text-field", {
                attrs: { fullWidth: "", label: "Poster", labelFloat: "" },
                model: {
                  value: _vm.visual.poster,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "poster", $$v)
                  },
                  expression: "visual.poster"
                }
              }),
              _vm._v(" "),
              _vm._l(_vm.posters, function(p) {
                return _c("img", {
                  staticClass: "form-poster",
                  attrs: { src: p },
                  on: {
                    click: function($event) {
                      _vm.visual.poster = p
          ...
          _c(
            ...
            [
              _c("mu-text-field", {
                attrs: { fullWidth: "", label: "Website", labelFloat: "" },
                model: {
                  value: _vm.visual.website,
                  callback: function($$v) {
                    _vm.$set(_vm.visual, "website", $$v)
                  },
                  expression: "visual.website"
                }
              })
            ],
            1
          ...
          _c(
            ...
            [
              _c(
                "mu-select-field",
                {
                  attrs: { fullWidth: "", label: "Visual Type" },
                  model: {
                    value: _vm.visual.visual_type,
                    callback: function($$v) {
                      _vm.$set(_vm.visual, "visual_type", $$v)
                    },
                    expression: "visual.visual_type"
                  }
                },
                [
                  _c("mu-menu-item", {
                    attrs: { value: "movie", title: "Movie" }
                  }),
                  _vm._v(" "),
                  _c("mu-menu-item", { attrs: { value: "tv", title: "Tv" } })
                ],
                1
              )
            ],
      ...
      _c(
        ...
        [
          _c("mu-text-field", {
            ...
            model: {
              value: _vm.visual.summary,
              callback: function($$v) {
                _vm.$set(_vm.visual, "summary", $$v)
              },
              expression: "visual.summary"
            }
          })
        ],
        1
          ...
          _c(
            ...
            _vm._l(_vm.songs, function(s) {
              return _c(
                ...
                [
                  _c("mu-avatar", {
                    attrs: { slot: "rightAvatar", src: s.image },
                    slot: "rightAvatar"
                  })
                ],
                1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0707a793", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SongForm_vue__ = __webpack_require__(9);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_04f73a28_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SongForm_vue__ = __webpack_require__(35);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SongForm_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_04f73a28_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SongForm_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "views/SongForm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-04f73a28", Component.options)
  } else {
    hotAPI.reload("data-v-04f73a28", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    ...
    [
        ...
        [
          _c(
            ...
            [
              _c(
                "mu-col",
                { attrs: { width: "100", tablet: "50", desktop: "50" } },
                [
                  _c("mu-text-field", {
                    attrs: {
                      fullWidth: "",
                  ...
                  _c(
                    "mu-list",
                    _vm._l(_vm.dataSource, function(s) {
                      return _c(
                        "mu-list-item",
                        {
                          key: "s.id",
              ...
              _c(
                ...
                [
                  _vm.song.url
                    ? _c("audio", { ref: "audio", attrs: { controls: "" } }, [
                        _c("source", {
                          attrs: { src: _vm.song.url, type: "audio/mpeg" }
                        })
                      ])
                    : _vm._e()
                ]
      ...
      _vm._v(" "),
      _c("mu-text-field", {
        attrs: { fullWidth: "", label: "Artist", labelFloat: "" },
        model: {
          value: _vm.song.artist,
          callback: function($$v) {
            _vm.$set(_vm.song, "artist", $$v)
          },
          expression: "song.artist"
        }
      }),
      _vm._v(" "),
      _c("mu-text-field", {
        attrs: { fullWidth: "", label: "source", labelFloat: "" },
        model: {
          value: _vm.song.url,
          callback: function($$v) {
            _vm.$set(_vm.song, "url", $$v)
          },
          expression: "song.url"
        }
      }),
      _vm._v(" "),
      _c("mu-text-field", {
        attrs: { fullWidth: "", label: "Image", labelFloat: "" },
        model: {
          value: _vm.song.image,
          callback: function($$v) {
            _vm.$set(_vm.song, "image", $$v)
          },
          expression: "song.image"
        }
      }),
      _vm._v(" "),
      _c("mu-raised-button", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-04f73a28", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ImageForm_vue__ = __webpack_require__(10);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_68374a20_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ImageForm_vue__ = __webpack_require__(37);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ImageForm_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_68374a20_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ImageForm_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "views/ImageForm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-68374a20", Component.options)
  } else {
    hotAPI.reload("data-v-68374a20", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "section",
    [
      _c("h2", [_vm._v("Visual Image Form")]),
      _vm._v(" "),
      _c("mu-text-field", {
        attrs: { fullWidth: "", label: "Title", labelFloat: "" },
        model: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-68374a20", esExports)
  }
}
...
var whatIWatched = 'https://what-i-watched.herokuapp.com/';
// const whatIWatched = '/';
...
var mutations = {
    loginAdmin: function loginAdmin(state) {
        state.admin = true;
    },
...
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_472cff63_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(47);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_MusicPlayer_vue__ = __webpack_require__(12);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1923b107_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_MusicPlayer_vue__ = __webpack_require__(46);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1923b107_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_MusicPlayer_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1923b107", Component.options)
  } else {
    hotAPI.reload("data-v-1923b107", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("f345dccc", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1923b107\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./MusicPlayer.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1923b107\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./MusicPlayer.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c(
    "div",
    { class: { opened: _vm.open }, attrs: { id: "player" } },
    [
      _c("div", {
        attrs: { id: "player__toggle" },
        on: {
          click: function($event) {
            _vm.toggle()
          }
      ...
      _vm.song.url
        ? _c("audio", { ref: "player", attrs: { controls: "" } }, [
            _c("source", { attrs: { src: _vm.song.url, type: "audio/mpeg" } })
          ])
        : _vm._e()
    ],
    1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1923b107", esExports)
  }
}
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    ...
    _c("h1", { staticClass: "title" }, [
      _vm._v(_vm._s(this.$store.state.languages[this.$store.state.lang].title))
    ]),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "layout" },
      [
        _c("router-link", { attrs: { to: "/" } }, [_vm._v("Visuals")]),
        _vm._v(" "),
